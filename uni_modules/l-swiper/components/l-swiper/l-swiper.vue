<template>
	<view class="l-swiper">
		<swiper :indicator-dots="indicatorDots" :autoplay="autoplay" :interval="interval" :duration="duration"
			class="swiper-box" :style="{'--height':height + 'rpx'}" :circular="circular"
			:previous-margin="type == 'card' ? '28rpx' : '0'" :next-margin="type == 'card' ? '28rpx' : '0'"
			@change="change">
			<swiper-item v-for="(item, index) in banner" :key="index" class="swiper-item">
				<image :src="item" class="swiper-image" :class="[currenIndex != index ? 'swiper-scsle' : '']"
