<template>
	...
	<view class="fixed w-[750rpx] left-0 bottom-0">
		<view class="p-4 flex justify-center items-center rounded-full">
			<button type="button" class="my-button-2 px-10 font-bold flex-1 ml-4"
				@click="showUpload = true">我已收到付款</button>
		</view>
	</view>
