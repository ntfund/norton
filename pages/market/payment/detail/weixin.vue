<template>
	<com-nav-bar title="微信支付详情"></com-nav-bar>
	<view class="p-4">
		<view class="row">
	...
	<u-modal :show="show" title="删除收款" content="将删除微信收款方式" confirmText="删除" showCancelButton confirmColor="#ff0000"
...
<script setup lang="ts">
	...
	const edit = () => {
		tools.navigateToWithEncode('/pages/market/payment/edit/weixin?params=' + props.params)
	}
